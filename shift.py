...
# 2. 入力ページ
    ...
    staff_list = ["加藤", "加川", "藪下", "香坂", "細野", "土佐", "田中","大高","中森","稲葉","村田","朝日","三浦","蓜島","早坂","関口","向井原","伊丹","永田","松本","石井","塚原","前田","岩見","山田","齊藤","淺川","山本","平尾","岡田","西峯","小田"] # 実際はフルリスト
    shops = ["渋谷", "上野", "秋葉原", "新橋", "新宿西", "池袋", "新宿東", "学大", "飯田橋", "銀座", "八重洲", "立川", "恵比寿" , "武蔵小山","白楽","下北沢駅前"]
